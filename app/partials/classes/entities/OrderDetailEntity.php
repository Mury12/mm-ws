...
use MMWS\Model\OrderDetail;
use MMWS\Controller\OrderDetailController;
...
class OrderDetailEntity
{
    ...
    {
        /**
         * @var OrderDetail $hasOrderDetail;
         */
        $hasOrderDetail = $this->getOne(['*'], true);
        if ($hasOrderDetail) {
            $fields = $this->model->toArray();
            $stmt = new PDOQueryBuilder($this->model->table);
            $stmt->update($fields);
    ...
    private function getOne(array $fields = [], bool $asobj = false)
    {
        ...
        try {
            ...
            if (sizeof($instance))
                return $asobj
                    ? (new OrderDetailController($instance[0]))->model
                    : $instance[0];
     ...
     * @param array $fields fields to return.
     * @param array $asobj returns as OrderDetail Object
     * @param bool $and sets if the filter sould be put with AND or OR

     * @return array|Array<OrderDetail>
     */
        ...
        try {
            ...
            if ($asobj) {
                return array_map(function ($instance) {
                    return (new OrderDetailController($instance))->model;
                }, $instances);
